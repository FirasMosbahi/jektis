...
export default function HeaderRoomsForm({
  onSubmit,
  isPopupOpen,
  setIsPopupOpen,
}: {
  ...
  return (
    <div className="flex flex-row items-center gap-2 justify-between border border-transparent border-gray-300 py-8 px-1">
      <div
        className="flex cursor-pointer flex-row gap-2"
        onClick={() => setIsPopupOpen(true)}
      >
        <Bagagge className="lg:size-6 size-5" />
