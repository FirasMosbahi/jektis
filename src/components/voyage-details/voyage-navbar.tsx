...
export default function VoyageNavbar({
  ...
  return (
    <div
      className="hidden py-1 tracking-[0.2em] xxl:text-[18px] lg:text-[17px] bg-gradient-to-r w-full from-[#004fa6] to-[#02c9b2] lg:inline-flex border-transparent rounded-xl shadow-sm mt-8"
      role="group"
    >
      <button
        type="button"
