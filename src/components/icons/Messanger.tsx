...
const SvgMessanger = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="url(#messanger_svg__a)"
      d="M400 0C174.7 0 0 165.1 0 388c0 116.6 47.8 217.4 125.6 287 6.5 5.8 10.5 14 10.7 22.8l2.2 71.2a32 32 0 0 0 44.9 28.3l79.4-35c6.7-3 14.3-3.5 21.4-1.6 36.5 10 75.3 15.4 115.8 15.4 225.3 0 400-165.1 400-388S625.3 0 400 0"
    />
    <path
      fill="#FFF"
